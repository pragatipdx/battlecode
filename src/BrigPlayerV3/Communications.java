...
public class Communications {
    ...
    boolean sendLocation(RobotController rc) throws GameActionException {
    ...
    boolean sendLocationExtraInfo(RobotController rc, int extraInfo) throws GameActionException {
        MapLocation location = rc.getLocation();
        int x = location.x, y = location.y;
